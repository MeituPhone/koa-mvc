...
module.exports = function webpackBaseConfig (NODE_ENV = 'development') {
    ...
    let plugins = [
        new ExtractTextPlugin({
            filename: 'v1/mobile/css/[name].css',
            allChunks: true
        }),
    ...
    const webpackConfig = {
        ...
        output: {
            ...
            filename: 'v1/mobile/js/[name].js',
            chunkFilename: 'v1/mobile/js/[name].js'
        },
        externals: {
            jquery: '$'
        },
        ...
        module: {
            rules: [
                ...
                },
                {
                    ...
                    loader: 'url-loader?limit=1&name=v1/mobile/images/[name].[ext]'
                },
                {
                    test: /\.(woff2?|eot|ttf|otf)(\?.*)?$/,
                    loader: 'file-loader?name=v1/mobile/fonts/[name].[ext]'
                },
                {
                    test: /\.(scss|css)$/,
